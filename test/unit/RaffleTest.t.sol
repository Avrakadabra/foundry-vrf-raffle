...
contract RaffleTest is CodeConstants, Test {
    ...
    // makeAddr is a Foundry cheatcode for making a new address of off some string
    ...
    function testEnterRaffleRevertsWithoutEnoughEth() public {
        // Arrange
        vm.prank(PLAYER);
        // Act /Asset
    ...
    function testDontAllowPlayersToEnterWhileRaffleIsCalculating() public {
        ...
        raffle.performUpkeep(""); // trigger the upkeep
    ...
    function testFullfillrandomWordsPicksAWinnerAndSendsMoney() public raffleEntered skipFork {
        ...
        assert(uint256(raffleState) == 0); // 0 = open
